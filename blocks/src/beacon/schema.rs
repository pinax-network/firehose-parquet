...
pub fn attestations_schema(include_fork_step: bool, encoding: &EncodeBytes) -> Schema {
    ...
    fields.extend(vec![
        ...
        Field::new("committee_index", DataType::UInt64, true),
        Field::new("aggregation_bits", bd.clone(), false),
        Field::new("beacon_block_root", bd.clone(), true),
        Field::new("source_epoch", DataType::UInt64, true),
        Field::new("source_root", bd.clone(), true),
        Field::new("target_epoch", DataType::UInt64, true),
        Field::new("target_root", bd.clone(), true),
        Field::new("signature", bd.clone(), false),
...
pub fn deposits_schema(include_fork_step: bool, encoding: &EncodeBytes) -> Schema {
    ...
    fields.extend(vec![
        ...
        Field::new("pubkey", bd.clone(), true),
        Field::new("withdrawal_credentials", bd.clone(), true),
...
pub fn proposer_slashings_schema(include_fork_step: bool, encoding: &EncodeBytes) -> Schema {
    ...
    fields.extend(vec![
        ...
        Field::new("header_1_slot", DataType::UInt64, true),
        Field::new("header_1_proposer_index", DataType::UInt64, true),
        Field::new("header_1_parent_root", bd.clone(), true),
        Field::new("header_1_state_root", bd.clone(), true),
        Field::new("header_1_body_root", bd.clone(), true),
        Field::new("header_2_slot", DataType::UInt64, true),
        Field::new("header_2_proposer_index", DataType::UInt64, true),
        Field::new("header_2_parent_root", bd.clone(), true),
...
pub fn attester_slashings_schema(include_fork_step: bool, encoding: &EncodeBytes) -> Schema {
    ...
    fields.extend(vec![
        Field::new("block_slot", DataType::UInt64, false),
        Field::new("slashing_index", DataType::UInt32, false),
        Field::new("attestation_1_slot", DataType::UInt64, true),
        Field::new("attestation_1_committee_index", DataType::UInt64, true),
        Field::new("attestation_1_beacon_block_root", bd.clone(), true),
        Field::new("attestation_1_source_epoch", DataType::UInt64, true),
        Field::new("attestation_1_source_root", bd.clone(), true),
        Field::new("attestation_1_target_epoch", DataType::UInt64, true),
        Field::new("attestation_1_target_root", bd.clone(), true),
        Field::new("attestation_2_slot", DataType::UInt64, true),
        Field::new("attestation_2_committee_index", DataType::UInt64, true),
        Field::new("attestation_2_beacon_block_root", bd.clone(), true),
        Field::new("attestation_2_source_epoch", DataType::UInt64, true),
        Field::new("attestation_2_source_root", bd.clone(), true),
        Field::new("attestation_2_target_epoch", DataType::UInt64, true),
        Field::new("attestation_2_target_root", bd, true),
...
pub fn bls_to_execution_changes_schema(include_fork_step: bool, encoding: &EncodeBytes) -> Schema {
    ...
    fields.extend(vec![
        ...
        Field::new("validator_index", DataType::UInt64, true),
        Field::new("from_bls_pubkey", bd.clone(), true),
