...
pub fn chunks_schema(include_fork_step: bool) -> Schema {
    let mut fields = canonical_fields();
    fields.extend(vec![
        Field::new("shard_id", DataType::UInt64, false),
        Field::new("chunk_hash", DataType::Utf8, false),
        Field::new("prev_state_root", DataType::Utf8, false),
...
pub fn receipts_schema(include_fork_step: bool) -> Schema {
    let mut fields = canonical_fields();
    fields.extend(vec![
...
pub fn state_changes_schema(include_fork_step: bool) -> Schema {
    let mut fields = canonical_fields();
    fields.extend(vec![
