...
| [#468](https://github.com/pinax-network/firehose-parquet/issues/468) | Runtime PR publication pending | Complete implementation independently reviewed on main `f555898`; 995 workspace tests plus the CI capture example passed. Actual interrupted Writing rollback, 14-table/12,298-row live equality, completed-bound no-op and deleted-mirror repair passed. Issue remains open until final PR CI and merge. |
